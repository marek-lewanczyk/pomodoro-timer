    ...
    return (
        <nav className="flex justify-center gap-4 py-4">
            <Button to="/" title="Timer" isActive={path === '/'}>
                <ClockIcon className={`h-8 w-8 ${path === '/' ? 'text-secondary dark:text-primary' : 'text-primary dark:text-secondary'}`} />
            </Button>

            <Button to="/statistics" title="Stats" isActive={path === '/statistics'}>
                <ChartBarIcon className={`h-8 w-8 ${path === '/statistics' ? 'text-secondary dark:text-primary' : 'text-primary dark:text-secondary'}`} />
            </Button>

            <Button to="/settings" title="Settings" isActive={path === '/settings'}>
                <Cog6ToothIcon className={`h-8 w-8 ${path === '/settings' ? 'text-secondary dark:text-primary' : 'text-primary dark:text-secondary'}`} />
            </Button>
