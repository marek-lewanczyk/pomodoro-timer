...
function TimerModeSelector({ mode, onSwitchMode }: TimerModeSelectorProps) {
    return (
        <div className="flex justify-center gap-4">
            ...
            <Button onClick={() => onSwitchMode('shortBreak')} isActive={mode === 'shortBreak'} title="Short break">
                <PauseIcon className="h-8 w-8" />
            </Button>

            <Button onClick={() => onSwitchMode('longBreak')} isActive={mode === 'longBreak'} title="Long break">
