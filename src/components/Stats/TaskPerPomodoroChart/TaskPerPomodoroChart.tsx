        ...
        <div className="p-4 border border-primary shadow font-vt323 text-sm dark:border-secondary dark:shadow-dark ">
            ...
            <ResponsiveContainer width="100%" height={400}>
                <BarChart data={data}>
                    ...
                    <XAxis
                        dataKey="name"
                        tick={{ fontFamily: chartTheme.fontFamily, fontSize: chartTheme.fontSize, fill: chartTheme.color_primary }}
                    ...
                    />
                    <Tooltip
                        wrapperStyle={{ fontFamily: chartTheme.fontFamily, fontSize: chartTheme.fontSize }}
                        contentStyle={{ border: chartTheme.border, backgroundColor: chartTheme.color_secondary }}
                    />
